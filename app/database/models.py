"""Database models."""
from sqlalchemy import Column, Integer, String, Boolean, ForeignKey, Date, Time, DateTime, Enum, Text, ARRAY, Numeric
...
class Appointment(Base):
    ...
    record = relationship("ConsultationRecord", back_populates="appointment", uselist=False)
    precheck = relationship("MedicalPrecheck", back_populates="appointment", uselist=False)
